...
class ApiClient
{
     ...
     */
    public function __construct(\mle\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @return mixed
     * @throws \mle\ApiException on a non 2xx response
     */
    public function callApi($path, $resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\mle\ObjectSerializer::sanitizeForSerialization($postData));
        }
